...
class Matern92(cov.CovarianceFunction):
    ...
    def __init__(self, theta, X=None, Y=None):
        ...
        if self.theta[0] <= 0.0 or self.theta[1] < 0.0:
            warnings.warn(
                "Illegal hyperparameters in the" + " initialization of Matern92."
            )
    ...
    def gradcovfunc(self):
        ...
        dk_dl = float(
            ...
            * rl**2
            / l
            * erl
            * (5.0 + 15.0 * rl + 18.0 * rl**2 + 9.0 * rl**3)
        )
    ...
    def ddcovfunc(self):
        ...
        dcov = (
            ...
            * sigmaf**2
            / l**2
            * erl
            * (5.0 + 15.0 * rl + 9.0 * rl**2 - 18.0 * rl**3 - 27.0 * rl**4)
        )
        return float(dcov)
    ...
    def d2d2covfunc(self):
        ...
        dcov = (
            ...
            * sigmaf**2
            / l**4
            * erl
            * (1.0 + 3.0 * rl - 3.0 * rl**2 - 18.0 * rl**3 + 9.0 * rl**4)
        )
        return float(dcov)
    ...
    def d2d3covfunc(self):
        ...
        dcov = (
            ...
            * erl
            * (self.x1 - self.x2)
            * (5.0 + 15.0 * rl - 30.0 * rl**2 + 9.0 * rl**3)
        )
        return float(dcov)
    ...
    def d3d3covfunc(self):
        ...
        dcov = (
            ...
            * sigmaf**2
            / l**6
            * erl
            * (5.0 + 15.0 * rl - 135.0 * rl**2 + 126.0 * rl**3 - 27 * rl**4)
        )
        return float(dcov)
    ...
    def dgradcovfunc(self):
        ...
        dgrad_l = float(
            ...
            * erl
            * (self.x1 - self.x2)
            * (-10.0 - 30.0 * rl - 27.0 * rl**2 + 9.0 * rl**3 + 27.0 * rl**4)
        )
